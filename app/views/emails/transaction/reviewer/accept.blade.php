{{-- อีเมลส่งให้ผจกทำหน้าที่ตรวจสอบและส่งงานต่อไป --}}
<table width="800" border="1">
	...
	<tr>
        <td style="background-color: #EEEEEE;" valign="top" width="200">เพิ่มเติม</td>
        <td valign="top">{{ $data['note'] }}</td>
    </tr>
	<tr>
        <td style="background-color: #EEEEEE;" valign="top" width="200">สถานะ</td>
        <td valign="top" style="color: green;"><strong>ผ่านการตรวจสอบเพื่อส่งให้ Manager มอบหมายงานในขั้นถัดไป</strong></td>
    </tr>
</table>
...
<p>
    ส่งข้อมูลนี้ต่อให้กับ Manager เพื่อมอบหมายงานผู้ประสานคณะต่อไปที่  <a href='{{{ URL::to("manager") }}}'>
        {{{ URL::to("manager") }}}
    </a>
</p>