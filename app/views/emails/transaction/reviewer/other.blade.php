{{-- อีเมลส่งให้ผู้ที่เกี่ยวข้องอื่นๆดูแลการรับคณะแทน --}}
<table width="800" border="1">
	...
	<tr>
        ...
        <td valign="top" style="color: orange;"><strong>คณะนี้ฝากให้หน่วยงานธุรการรับรอง</strong></td>
    </tr>
	<tr>
        <td style="background-color: #EEEEEE;" valign="top" width="200">รายละเอียดเพิ่มเติม</td>
        <td valign="top">{{ $data['other_note'] }}</td>
    </tr>
</table>
...
<p>
    หากมีข้อสงสัยเพิ่มเติมประการใดติดต่อได้ที่ Admin ระบบได้ที่ luadmin@doitung.org หรือ เบอร์ติดต่อ 320
</p>