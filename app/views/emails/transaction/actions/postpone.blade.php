{{-- อีเมลส่งให้ทุกท่านใน loop ว่าคณะเลื่อนกำหนดการแบบไม่มีกำหนด --}}
<table width="800" border="1">
    ...
    <tr>
        ...
        <td valign="top" style="color: green;"><strong><font color="#eb9316">ขอเลื่อนดูงานไม่มีกำหนด</font></strong></td>
    </tr>
    <tr>
