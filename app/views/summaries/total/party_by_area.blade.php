{{--หน้าสรุปจำนวนคณะแยกพื้นที่ดูงาน--}}
@extends('svms.layouts.reporting')

@section('title')
    รายงานสรุปจำนวนคณะแยกพื้นที่ดูงาน(ดอยตุง-น่าน)
@stop
...
@section('content')
    ...
    <div class="page-header">
        <h3>
			<i class="fa fa-bar-chart" aria-hidden="true"></i> รายงานสรุปจำนวนคณะแยกตามพื้นที่ดูงาน
        </h3>
    </div>
		...
		<div id="search" class="panel-collapse collapse in">
			<div class="panel-body">
				<form id="report_form" name="form" class="form-horizontal" role="form" method="POST">
					...
					<div class="form-group">
						<label for="areaBy" class="col-sm-3 control-label">พื้นที่ดูงาน</label>
						<div class="col-sm-9">
							<select class="form-control" name="area" id="areaBy" style="width: 100%">
								<option value="">ทั้งหมด</option>
								<option value="doitung">ดอยตุง(รวมปางมะหันกับปูนะ)</option>
								<option value="nan">น่าน</option>
								<option value="doitung">ดอยตุง+น่าน</option>
								<option value="bkk">กทม.</option>
								<option value="other">อื่นๆ (กรณีนอกเหนือจากเคสข้างบน)</option>
							</select>
						</div>
					</div>
