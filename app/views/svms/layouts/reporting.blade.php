...
<head>
    ...
    <title> Living University Management Reporting Service ::
        @section('title')
            Dashboard
        @show
    </title>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-text">Living University Management :: Reporting Service</p>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav pull-right">
                <li><a href="{{{ URL::to('/') }}}"><i class="fa fa-tachometer"></i> </i> Dashboard</a></li>
                <li><a href="{{{ URL::to('report') }}}"><i class="fa fa-book"></i> รายงานระบบ</a></li>
                <li class="divider-vertical"></li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-user"></span> {{{ (Auth::user()->hasRole('admin')) ? Auth::user()->username : Auth::user()->getShortName() }}} <span class="caret"></span>
                    </a>
