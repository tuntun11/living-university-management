...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'svms.partials.user.login',
    'signup_form' =>            'svms.partials.user.signup',
    'forgot_password_form' =>   'svms.partials.user.forgot_password',
    'reset_password_form' =>    'svms.partials.user.reset_password',
