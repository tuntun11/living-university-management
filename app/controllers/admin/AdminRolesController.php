...
class AdminRolesController extends AdminController {
    ...
    public function getData()
    {
        ...
        ->add_column('actions', function($row){
            return '<a href="' . URL::to('admin/roles/' . $row->id . '/edit' ) . '" class="iframe btn btn-xs btn-default">แก้ไข</a> <a href="' . URL::to('admin/roles/' . $row->id . '/delete' ) . '" class="iframe btn btn-xs btn-danger">ลบ</a>';
        })
