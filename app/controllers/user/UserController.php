...
class UserController extends BaseController {
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return View::make('svms/user/index', compact('user'));
    }
    ...
    public function getLogin()
    {
        ...
        return View::make('svms/user/login');
    }
    ...
    {
        return View::make('svms/user/forgot');
    }
    ...
    public function getReset( $token )
    {
        ...
        return View::make('svms/user/reset')
            ->with('token',$token);
    }
    ...
    /*public function getProfile($username)
    {
        ...
        return View::make('svms/user/profile', compact('user'));
    }*/
    ...
    public function postSettings()
    {
        ...
        if($user)
        {
            $personnel = $user->getPerson($user->id);
            ...
            if($personnel->save())
            {
                return Redirect::to('user/setting')->with('status', 'success')->with('msg', 'Success ปรับปรุงข้อมูลสำเร็จ !');
            }
            return Redirect::to('user/setting')->with('status', 'error')->with('msg', 'Error ไม่สามารถปรับปรุงข้อมูลได้');
        }
        return Redirect::to('user/setting')->with('status', 'error')->with('msg', 'Error ข้อมูลในการกรอกไม่สมบูรณ์');
    }
